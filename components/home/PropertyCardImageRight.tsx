      ...
      <Wrapper maxWidth="1216px" className="h-[504px] flex items-center">
        ...
        <div className="w-6/12 h-full flex justify-center items-center">
          <div className="w-[592px] h-[504px] relative z-10">
            <div className="w-[72px] h-[72px] absolute top-[68px] left-[68px] z-40 cursor-pointer">
              <Icon name="play" color="blue-500" size="72" />
            </div>
            <div className="w-[458px] h-[400px] absolute bottom-0 left-0 z-20 rounded-[8px]">
              <Image
                src={image_one}
                alt="image"
                width={458}
            ...
            <div className="w-[452px] h-[240px] absolute top-[-6px] left-[104px] z-30 rounded-[8px]">
              <Image
                src={image_two}
                alt="image"
                width={452}
...
export default PropertyCardImageRight;
